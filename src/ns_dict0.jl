...
# tags
_NSdict0[:cst] = ns -> NSTag{:cst}(ns)
_NSdict0[:prp] = ns -> NSTag{:prp}(ns)
_NSdict0[:fnc] = ns -> NSTag{:fnc}(ns)
_NSdict0[:mth] = ns -> NSTag{:mth}(ns)
_NSdict0[:dfn] = ns -> NSTag{:dfn}(ns)
_NSdict0[:req] = ns -> NSTag{:req}(ns)
